public static class EntityAttributeIds
{
    public const string Entity = "entity";
    public const string Unit = "entity.unit";
    public const string Building = "entity.building";
    ...
    public const string NotSelectable = "interaction.not_selectable";
    public const string Controllable = "interaction.controllable";
    public const string Own = "interaction.own";
