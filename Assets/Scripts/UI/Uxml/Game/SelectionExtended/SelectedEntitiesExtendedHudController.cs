...
public sealed class SelectedEntitiesExtendedHudController : MonoBehaviour
{
    ...
    {
        NetworkEntityCoordinator system = subscribedSystem ?? NetworkEntityCoordinator.Instance;
    ...
    private void CreateSlots()
    {
        ...
        for (int index = 0; index < MaxVisibleGroups; index++)
        {
            ...
            slot.clicked += () => NetworkEntityCoordinator.Instance?.SetInspectedSelectionGroup(capturedIndex);
